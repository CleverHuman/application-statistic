...
export function AppShell({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative flex min-h-screen overflow-hidden bg-gradient-to-br from-purple-50 via-pink-50 to-fuchsia-100 dark:from-purple-950 dark:via-zinc-950 dark:to-pink-950">
